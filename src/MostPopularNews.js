        ...
        <div>
            ...
            <span>
                ...
                <ul>
                    ...
                    <li><a href="#" className="tit">고개 숙인 공매도의 전설..시트론 대표 "다시는 공매도 리포트 안낸다" [株포트라이트]</a></li>
                    <li><a href="#" className="tit">[특징주] 노바백스 관련주 주목.. 'SK케미칼·디알젬·켐온'</a></li>
                    <li><a href="#" className="tit">게임스탑 공매도 사태에 웃었다..어부지리 급등 종목 속출 [株포트라이트]</a></li>
